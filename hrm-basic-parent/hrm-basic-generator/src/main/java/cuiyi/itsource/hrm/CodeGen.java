...
public class CodeGen {
    ...
    public static void main(String[] args) throws Exception {
        ...
        focList.add(new FileOutConfig(templatePath) {
            ...
            public String outputFile(TableInfo tableInfo) {
                return projectPath + properties.getProperty("interfaceOutputDir")
                        + "/cuiyi/itsource/hrm/domain/" + tableInfo.getEntityName() + StringPool.DOT_JAVA;
            }
        });
        //query自定义生成路径
        ...
        focList.add(new FileOutConfig(templatePath) {
            ...
            public String outputFile(TableInfo tableInfo) {
                return projectPath + properties.getProperty("interfaceOutputDir")
                        + "/cuiyi/itsource/hrm/query/" + tableInfo.getEntityName() + "Query" + StringPool.DOT_JAVA;
            }
        });
        ...
        focList.add(new FileOutConfig(templatePath) {
            ...
            public String outputFile(TableInfo tableInfo) {
                ...
                return projectPath + properties.getProperty("mapperOutputDir")+ "/cuiyi/itsource/hrm/mapper/"
